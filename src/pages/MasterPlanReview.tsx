            ...
            <div className="card-content">
              <div className="space-y-0">
                {editedPlan.dailyPlans.map((day, index) => (
                  ...
                  >
                    <div className="flex items-center justify-center w-8 h-full min-h-[120px] cursor-grab flex-shrink-0">
                      <GripVertical className="h-6 w-6 text-white/50 hover:text-white/70 transition-colors" />
                    </div>
