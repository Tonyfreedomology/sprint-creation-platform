  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-lg",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-glow transform hover:scale-105 transition-all duration-300 shadow-[0_0_30px_rgba(34,223,220,0.4)]",
        gradient: "bg-gradient-secondary text-primary-foreground hover:shadow-card transform hover:scale-105 transition-all duration-300 shadow-[0_0_25px_rgba(34,223,220,0.3)]",
        elegant: "bg-gradient-card text-foreground border border-primary/20 hover:border-primary/40 hover:shadow-elegant transition-all duration-300 shadow-[0_0_20px_rgba(34,223,220,0.2)]",
        glow: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_25px_rgba(34,223,220,0.5)] hover:shadow-[0_0_35px_rgba(34,223,220,0.6)]",
      },
      size: {
